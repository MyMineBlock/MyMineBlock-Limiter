...
namespace NLMMB
{
    public partial class FormUtility : Form
    {
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DisposeAndCreateFilters(uint.Parse(textBox7.Text), uint.Parse(textBox1.Text), uint.Parse(textBox2.Text), uint.Parse(textBox3.Text), uint.Parse(textBox4.Text), uint.Parse(textBox5.Text), uint.Parse(textBox6.Text), uint.Parse(textBox33.Text));

                object[] hotkeyArray = new object[]
                {
                    checkBox1.Checked, (ModKeys)Enum.Parse(typeof(ModKeys), textBox9.Text), (Keys)Enum.Parse(typeof(Keys), textBox21.Text),
                    checkBox2.Checked, (ModKeys)Enum.Parse(typeof(ModKeys), textBox10.Text), (Keys)Enum.Parse(typeof(Keys), textBox22.Text),
                    checkBox3.Checked, (ModKeys)Enum.Parse(typeof(ModKeys), textBox11.Text), (Keys)Enum.Parse(typeof(Keys), textBox23.Text),
                    checkBox4.Checked, (ModKeys)Enum.Parse(typeof(ModKeys), textBox12.Text), (Keys)Enum.Parse(typeof(Keys), textBox24.Text),
                    checkBox5.Checked, (ModKeys)Enum.Parse(typeof(ModKeys), textBox13.Text), (Keys)Enum.Parse(typeof(Keys), textBox25.Text),
                    checkBox6.Checked, (ModKeys)Enum.Parse(typeof(ModKeys), textBox14.Text), (Keys)Enum.Parse(typeof(Keys), textBox26.Text),
                    checkBox10.Checked, (ModKeys)Enum.Parse(typeof(ModKeys), textBox18.Text), (Keys)Enum.Parse(typeof(Keys), textBox30.Text),
                    checkBox12.Checked, (ModKeys)Enum.Parse(typeof(ModKeys), textBox20.Text), (Keys)Enum.Parse(typeof(Keys), textBox32.Text),
                    checkBox9.Checked, (ModKeys)Enum.Parse(typeof(ModKeys), textBox17.Text), (Keys)Enum.Parse(typeof(Keys), textBox29.Text),
                    checkBox7.Checked, (ModKeys)Enum.Parse(typeof(ModKeys), textBox15.Text), (Keys)Enum.Parse(typeof(Keys), textBox27.Text),
                    checkBox11.Checked, (ModKeys)Enum.Parse(typeof(ModKeys), textBox19.Text), (Keys)Enum.Parse(typeof(Keys), textBox31.Text),
                    checkBox8.Checked, (ModKeys)Enum.Parse(typeof(ModKeys), textBox16.Text), (Keys)Enum.Parse(typeof(Keys), textBox28.Text)
                };
                GetHotKeySettings(hotkeyArray);
        ...
        {
            MessageBox.Show("This is the final version before a massive upgrade!");
        }
